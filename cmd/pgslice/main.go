...
func RunApp(args []string) {
	...
	app.Commands = []cli.Command{
		...
		},
		{
			...
			Action: func(ctx *cli.Context) error {
				return pgslice.AddPartitions(ctx)
			},
			Flags: []cli.Flag{
				cli.BoolFlag{
					Name:  "intermediate",
